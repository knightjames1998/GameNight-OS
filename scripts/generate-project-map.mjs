...
const ZONES = [
  ...
  },
  {
    ...
    items: [
      ...
      { t: "Smash: FFA + KOTH + Best Of + characters + TV", bg: "#c3fae8", h: 52 },
      { t: "Mario Kart: Free / Grand Prix / Best Of / KOTH", bg: "#c3fae8", h: 52 },
      { t: "Ping Pong: Free Play / Best Of / KOTH + TV", bg: "#c3fae8" },
  ...
  },
  {
    ...
    items: [
      { t: "Mario Kart character-stats panel (like Smash)" },
  ...
  },
  {
    ...
    items: [
      ...
      { t: "FIXED: same-event replays dropped ledger rows (per-session key)", bg: "#b2f2bb", h: 52 },
      { t: "FIXED: best-of results lost when night ended mid-set", bg: "#b2f2bb", h: 52 },
