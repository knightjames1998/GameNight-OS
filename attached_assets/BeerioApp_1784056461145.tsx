...
export default function App(){
  ...
  useEffect(()=>{
    ...
    let sameEvent=false;
    try{sameEvent=localStorage.getItem("gamenight-beerio-event-v1")===ev;}catch{/* still prefill */}
    // Skip only if we already prefilled THIS event and the user has since
    // put something on the board. An empty setup screen always refills.
