...
## Now / Next
Authoritative list lives in BACKLOG.md under NEXT UP. As of 2026-07-25 (map redraw pass)
the three committed next slots are still open; James has not committed them. Top
candidates in priority order:
1. Smashdown night (Smash pack format, cheapest remaining pack work)
2. Smash Tournament format (bracket from the Smash roster, materialized with fighters)
3. Tabletop theme + a user-facing theme switcher (Arcade default)
